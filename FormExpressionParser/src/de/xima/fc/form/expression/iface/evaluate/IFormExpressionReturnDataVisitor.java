...
public interface IFormExpressionReturnDataVisitor<R,T,E extends Throwable>
{
	...
	public R visit(ASTTernaryExpressionNode node, T data) throws E;
	public R visit(ASTParenthesisExpressionNode node, T data) throws E;
	...
	public R visit(ASTScopeExternalNode node, T data) throws E;
	public R visit(ASTVariableDeclarationClauseNode node, T data) throws E;
	public R visit(ASTScopeManualNode node, T data) throws E;
	public R visit(ASTScopeGlobalNode node, T data) throws E;
