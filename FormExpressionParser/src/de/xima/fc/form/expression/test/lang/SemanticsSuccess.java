...
enum SemanticsSuccess implements ITestCase {
	...
	CONTROL010("i=0;lbl:switch(1){case (++i): break lbl; case(++i): ++i;};i;", NumberLangObject.create(1)),
	CONTROL011("(true ? 20 : 0) + (false ? 0 : 22);", Tests.N42),
	CONTROL012("outer:while(true){inner:for(i in 10){if(i>5) break outer;continue inner;}}", NullLangObject.getInstance()),
