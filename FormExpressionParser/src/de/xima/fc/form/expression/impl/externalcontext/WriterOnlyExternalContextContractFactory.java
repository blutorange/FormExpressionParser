...
public class WriterOnlyExternalContextContractFactory extends AGenericExternalContextFactory<Writer> {
	...
	private static class InstanceHolder {
		@Nonnull
		public final static IExternalContextContractFactory<Writer> INSTANCE = new WriterOnlyExternalContextContractFactory();
	}

	private static class WriterOnlyExternalContext extends AGenericExternalContext implements IExternalContext {
