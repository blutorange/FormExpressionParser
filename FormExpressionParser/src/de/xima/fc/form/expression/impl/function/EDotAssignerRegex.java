...
public enum EDotAssignerRegex implements IDotAssignerFunction<RegexLangObject> {
	;
	...
	private EDotAssignerRegex(final Impl impl) {
	...
	private static enum Impl implements IDotAssignerFunction<RegexLangObject> {
		;
