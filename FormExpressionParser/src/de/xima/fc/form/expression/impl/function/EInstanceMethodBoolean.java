...
public enum EInstanceMethodBoolean implements IMethod2Function<BooleanLangObject> {
	;
	private final EMethod method;
	private final IFunction<BooleanLangObject> function;

	private EInstanceMethodBoolean(final EMethod method, final IFunction<BooleanLangObject> function) {
		this.method = method;
	...
	private static enum Func implements IFunction<BooleanLangObject> {
		;
