...
/**
 * Keeps a list for each nesting level separately for each variable. Creates new
...
public class QueueBinding implements IBinding {
	...
	/**
	 * Value returned when variable is not in scope. May be overridden to
	 * provide other default values.
	 *
	 * @param name
	 *            Name of the form field. Defaults to throwing a
	 *            {@link VariableNotDefinedException} when not overridden.
	 */
