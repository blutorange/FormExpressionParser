...
CodeMirror.defineSimpleMode("formexpression-template", {
  ...
  code: [
    ...
    {regex: /(?:function|with|return|throw|continue|break|var|global|scope|require|if|for|while|else|do|try|catch|switch|case|default|loginfo|logwarn|logerror|logdebug)\b/, token: "keyword"},
