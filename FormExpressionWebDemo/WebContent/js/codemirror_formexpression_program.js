...
CodeMirror.defineSimpleMode("formexpression-program", {
  ...
  start: [
    ...
    {regex: /(?:function|with|return|throw|var|global|scope|require|continue|break|if|for|while|else|do|try|catch|switch|case|default|loginfo|logwarn|logerror|logdebug)\b/, token: "keyword"},
